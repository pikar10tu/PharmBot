...
- [ ] **Step 4b: เติม `year` ของเอกสาร CCPE 3 ฉบับ**

`AR.pdf` ยืนยันแล้ว (2026-08-09) — **ทั้งเล่ม 260 หน้าคือตัว CPG** ไม่ใช่วารสารรวมหลายบทความ
เลขหน้าวารสาร = หน้า PDF + 52 (วารสาร 53 = PDF 1, วารสาร 312 = PDF 260)
บรรณานุกรมเริ่ม **PDF 182** (วารสาร 234) ยาวถึงหน้าสุดท้าย → `pages: "1-181"` ตัดรายการอ้างอิง 79 หน้าออก

ยังเหลือ: เปิดหน้าปก/หน้าลิขสิทธิ์ของ `ccpe739_std`, `ccpe953_uti`, `ccpe461_uri` อ่านปีที่เผยแพร่จริงแล้วเติม `year`
**ห้ามใช้ PDF metadata** (ของ `ccpe461_uri` คือ 2018 ซึ่งเป็นวันบันทึกไฟล์ ไม่ใช่ปีเผยแพร่) — ค่านี้ไปแสดงเป็น citation ต่อนักศึกษา

รหัสกิจกรรม CPE ที่พิมพ์อยู่หัวบทความมักมีปีต่อท้าย เช่น `1014-1-000-003-07-2560` → พ.ศ. 2560

Expected: `year` ไม่มีตัวไหนเป็น `null` เหลืออยู่
