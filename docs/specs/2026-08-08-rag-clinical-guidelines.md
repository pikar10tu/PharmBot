...
**N3 Stroke — ยังหาไม่ได้**
`hemorrhagic-2008` ที่มีอยู่ใช้ไม่ได้ (เลือดออกในสมองอย่างเดียว, พ.ศ. 2551, เขียนให้แพทย์ใน รพ.)
ฉบับ ischemic ของ neurothai ที่เข้าถึงได้เป็นปี 2007 ยิ่งเก่ากว่า และเป็นแนวรักษาใน รพ. เช่นกัน
สิ่งที่ต้องการคือเอกสารแนว **recognition + referral** (FAST/BEFAST, golden period, ช่องทางส่งต่อ) สำหรับบุคลากรนอก รพ.

บรรเทาชั่วคราว: `f6cdf409` มีหัวข้อภาวะปวดศีรษะฉุกเฉิน (น.1-7, 15) และหลอดเลือดสมอง (น.8, 10)
ครอบคลุมส่วน "ปวดศีรษะแบบไหนต้องส่งต่อ" ได้บางส่วน แต่ไม่ครอบ FAST/อ่อนแรงครึ่งซีก
